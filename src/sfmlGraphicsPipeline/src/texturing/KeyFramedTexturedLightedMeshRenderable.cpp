#include "./../../include/texturing/KeyFramedTexturedLightedMeshRenderable.hpp"
...
KeyFramedTexturedLightedMeshRenderable::~KeyFramedTexturedLightedMeshRenderable()
{
...
void KeyFramedTexturedLightedMeshRenderable::addLocalTransformKeyframe( const GeometricTransformation& transformation, float time )
{
  m_localKeyframes.add( transformation, time );
}

void KeyFramedTexturedLightedMeshRenderable::addParentTransformKeyframe( const GeometricTransformation& transformation, float time )
{
  m_parentKeyframes.add( transformation, time );
}

void KeyFramedTexturedLightedMeshRenderable::do_draw()
{
    //Location
...
void KeyFramedTexturedLightedMeshRenderable::do_animate(float time) {
...
void KeyFramedTexturedLightedMeshRenderable::setMaterial(const MaterialPtr& material)
{
    m_material = material;
}
